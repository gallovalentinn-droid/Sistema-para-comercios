...
|---|---|---|
| Build observado coincide con RC2 | aprobado | GitHub Pages publicó `packageRevision: 14` desde el commit `3a0386c`; HTTP 200, acceso de empleados y códigos de validación verificados el 14/09/2026 |
...
| 148 pruebas locales PASS | aprobado | verificación de implementación REV14: 148/148; suite pública: 22/22 |
| Acceso de empleado real | pendiente | la interfaz y el contrato cliente están publicados; falta ingresar con un empleado real del comercio piloto |
| Lector IA REV13 completa una invocación | pendiente | los intentos 14 y 15 confirmaron timeout local a 25 s; Edge versión 17 ya amplió la ventana a 90 s y falta el smoke posterior |
...
- El comercio piloto tiene 15 de 100 intentos mensuales consumidos; quedan 85. El intento 12 fue la invocación HTTP 200 del 12/09/2026; el 13 falló por credencial inválida y los intentos 14 y 15 fueron cancelados por el timeout anterior de 25 segundos.
...
- 148/148 pruebas locales repetidas:
