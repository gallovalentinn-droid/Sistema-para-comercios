...
**Fecha:** 23/09/2026
**Base:** REV32 (`10614fa`)
**Alcance:** correcciones de la auditoría funcional REV32, sin publicar la beta pública.
...
- **Entorno público:** no se publicó REV33 ni se repitieron los escenarios en `micomercio.ar/beta/`. Esta entrega es el sistema completo listo para revisión local.
...
- No se aplicaron migraciones ni se probaron flujos autenticados contra la beta pública en esta revisión.
