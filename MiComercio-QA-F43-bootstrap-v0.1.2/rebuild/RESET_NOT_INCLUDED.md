...
de tener V3→F4.2 reproducible dejaría el laboratorio en un estado peor y obligaría
...
F3.2 queda fuera de esta condición porque es baseline cliente y no modifica schema.
