...
- La pantalla de acceso separa dueño/administrador de empleado. El empleado ingresa con código de comercio, usuario y contraseña a través de `f5-login`; el correo técnico permanece oculto y la sesión resultante se valida contra el contexto V4 antes de mostrar el POS.
...
- 148 pruebas declaradas. REV14 agrega cinco regresiones para impedir que el acceso de empleados vuelva a desviarse hacia el formulario de correo del dueño.
